...
function Color.New(gui : ScreenGui,mouse : PlayerMouse,params : any)
	params = template(params,{
		Position = UDim2.new(0.04, 0,0.114, 0),
		Draggable = true,
		RoundedCorners = true,
	...
	--create
	self:Create()
	self.Window = self.Instance.Parent
	--wheel
...
--		self.Instance.Parent.Topbar.Button.Visible = false
		...
		self._valueDownFunc = runService.Heartbeat:Connect(function()
			...
			self.Color = Color3.fromHSV(hue,saturation,1 - pos);
			self:UpdateColor()
		end)
...
--		self.Instance.Parent.Topbar.Button.Visible = true
	...
	self.Instance.Right.Value.Button.HoverFrame.MouseLeave:Connect(function()
		--		self.Instance.Parent.Topbar.Button.Visible = true
		_resetValueFunc()
	end)
	...
	self.Instance.Bottom.Buttons.Confirm.ImageColor3 = Color3.new(1,1,1)
...
function Color:Create()
	...
	sample.Properties.RGB.R.TextLabel.TextColor3 = Color3.new(1,1,1)
	sample.Properties.RGB.G.TextLabel.TextColor3 = Color3.new(1,1,1)
	sample.Properties.RGB.B.TextLabel.TextColor3 = Color3.new(1,1,1)
	
	
	sample.Properties.TransparencyFrame.Selection.TextLabel.TextColor3 = Color3.new(1,1,1)
	sample.Properties.Overlay.TextLabel.TextColor3 = Color3.new(1,1,1)
	sample.Properties.TransparencyFrame["Selection 2"].TextLabel.TextColor3 = Color3.new(1,1,1)
	sample.Properties.TransparencyFrame["Selection 2"].Frame.TextBox.TextColor3 = Color3.new(0.196078, 0.196078, 0.196078)
	sample.Properties.TransparencyFrame["Selection"].Frame.TextBox.TextColor3 = Color3.new(0.196078, 0.196078, 0.196078)
