...
function Color.New(gui : ScreenGui,mouse : PlayerMouse,params : any)
	params = template(params,{
		Position = UDim2.new(0.124, 0,0.011, 0),
		Draggable = true,
		RoundedCorners = true,
...
function Color:Create()
	...
	sample.Properties.Particles.R.TextLabel.TextColor3 = Color3.new(1,1,1)
	sample.Properties.Particles.T.TextLabel.TextColor3 = Color3.new(1,1,1)
	sample.Properties.Particles.S.TextLabel.TextColor3 = Color3.new(1,1,1)
